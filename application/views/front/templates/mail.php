...
$to      = "akhilesh@evolvelearningsolutions.com";
$from    = $_POST['email'];
...
$message = $messageBody = "<html>
				...
				<tr style='height: 50px;     padding-left: 15px;'><td align='left'>First Name </td> <td align='left'>".$_POST['fname']."</td></tr>
				
				<tr style='height: 50px; padding-left: 15px;'><td align='left'>Last Name  </td> <td align='left'> ".$_POST['lname']."</td></tr>
				
				<tr style='height: 50px; padding-left: 15px;'><td align='left'>Phone Number  </td> <td align='left'> ".$_POST['phone']."</td></tr>
				
				<tr style='height: 50px; padding-left: 15px;'><td align='left'>Email  </td> <td align='left'>".$_POST['email']."</td></tr>

				<tr style='height: 50px; padding-left: 15px;'><td align='left'>Company's Name </td> <td align='left'>".$_POST['company']."</td></tr>
				
				<tr style='height: 50px; padding-left: 15px;'><td align='left'>Message  </td> <td align='left'>".$_POST['message']."</td></tr>
				</table>
			</html>";
