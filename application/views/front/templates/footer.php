...
<script type=\"text/javascript\">
            ...
            alert('Thank you for contacting us! We have received your message and will respond to you within 24 hours.Have a great day ahead!');
...
<script type="text/javascript">
 function Redirect() {
               window.location="http://www.evolvelearningsolutions.com/Contact";
            }
</script>
...
<?php /*
 if (isset($_POST['submit'])){
    ?>
    <script type="text/javascript">alert("Your details have been saved successfully.")</script>
<?php } */ ?>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="fname" onkeypress="return onlyAlphabets(event,this);" placeholder="First Name" autocomplete="off" />                                        
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input type="text" class="form-control" name="lname" onkeypress="return onlyAlphabets(event,this);" placeholder="Last Name" autocomplete="off" />                                        
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                             ...
                             <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="company" placeholder="Company's Name" autocomplete="off" />                                        
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                    <input type="text" class="form-control" name="phone" value="" placeholder="Phone No" autocomplete="off" maxlength="12" onkeypress="number(event)" />                                        
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
    						<div class="col-xs-12 col-md-12 form-group">
								<div class="input-group">
									<input type="file" name="fileatt"  autocomplete="off" class="custom-file-input" />
                            ...
                            <div class="col-xs-12 col-md-12 form-group">
                                <div class="input-group">
                                    ...
                                    <textarea name="message" class="form-control" rows="7" placeholder="Please Type Your Message Here"></textarea>                                       
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 form-group">
 ...
 $(document).ready(function() {
   ...
   /*   fileatt: {
     ...
     company: {
                validators: {
                    notEmpty: {
                        company: 'The Message is Required and Cannot be Empty'
                    }
                }
            },    
