            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form1">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/news" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control"placeholder="Your News Name"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" name="date" data-required="1" class="form-control"placeholder="Your News Name"/>
                                    </div>
                                </div>
