    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Category Form  <small>Edit  category</small></h1>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/category_edit" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control"placeholder="Your Category Name" value="<?php echo $menu->category_name; ?>"/>
                                    </div>
                                </div>
                              ...
                              <div class="form-group last">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="ckeditor form-control" name="editor" rows="6" data-error-container="#editor2_error">
