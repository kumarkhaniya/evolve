    ...
    <div class="page-content">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light">
                            <form action="<?php echo base_url(); ?>Admin/edit_logo" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                <?php foreach ($logo as $logo)  ?>
            <img src="<?php echo base_url(); ?>images/admin/logo/<?php echo $logo->image; ?>" alt=""/>
            <input type="hidden" value="<?php echo $logo->image; ?>" name="old_image">
            <input type="hidden" value="<?php  echo $_GET['id']?>" name="id">
                           ...
                           <input type="submit" value="submit" name="edit_logo" class="btn green-haze">
