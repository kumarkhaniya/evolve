    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>News Form  <small>Add new News</small></h1>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-photo"></i>Add News
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form1">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/edit_news" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control"placeholder="Your News Name" value="<?php echo $news->name; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="<?php  echo base_url(); ?>images/admin/news/<?php echo $news->image;?>" alt=""/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" name="date" data-required="1" class="form-control"placeholder="Your News Name" value="<?php echo $news->date; ?>"/>
                                    </div>
                                </div>
