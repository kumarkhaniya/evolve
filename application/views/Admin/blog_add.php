    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Blog Form  <small>Add new Expertise</small></h1>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-tasks"></i>Add Blog
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/blog" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control"placeholder="Your Blog Name"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="title_demo" data-required="1" class="form-control"placeholder="Your Blog Name"  />
                                    </div>
                                </div>
                              ...
                              <div class="form-group last">
                                ...
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="ckeditor form-control" name="editor-1" rows="6" data-error-container="#editor2_error"></textarea>
                                        <div id="editor2_error">
                                        </div>
                                    </div>
                                </div>
