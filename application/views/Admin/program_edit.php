    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Program Edit Form  <small>Update Program</small></h1>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-tasks"></i>Edit Program
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/program_edit" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control"placeholder="Your Program Name" value="<?php echo $menu->menuName; ?>"/>
                                    </div>
                                </div>
                              ...
                              <img src="<?php echo base_url(); ?>images/admin/program/<?php echo $menu->image; ?>" alt=""/>
                                            </div>
