    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Expertise Edit Form  <small>Update Expertise</small></h1>
            </div>
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(); ?>Admin/Expertise">Expertise</a>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-tasks"></i>Edit Expertise
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>Admin/Expertise_edit" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="url" data-required="1" class="form-control"placeholder=" Enter Url " value="<?php echo $menu->menuUrl;  ?>"/>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="control-label col-md-3">Title-Description 
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="title_name" data-required="1" class="form-control"placeholder="Your Title Name" value="<?php echo $menu->menuTargetWindow; ?>"/>
                                    </div>
                                </div>
                               ...
                               <input type="hidden" name="old_image" value="<?php echo $menu->image; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                              <img src="<?php echo base_url(); ?>images/admin/Expertise/<?php echo $menu->image_2; ?>" alt=""/>
                                            </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                            </div>
                                            <div>
                               ...
                               <input type="hidden" name="image_old" value="<?php echo $menu->image_2; ?>">
